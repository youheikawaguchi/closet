...
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
    VALUES(1,1,1,1,1,1, '/uploads/testid/picture.jpg',"メモ");
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
        VALUES(2,3,1,1,1,3, '/uploads/testid/picture1.jpg',"comant1");
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
        VALUES(3,3,1,1,1,3, '/uploads/testid/picture2.jpg',"hoge2");
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
        VALUES(4,1,1,1,1,3, '/uploads/testid/picture3.jpg',"comant3");
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
        VALUES(5,1,1,1,1,3, '/uploads/testid/picture4.jpg',"hoge4");
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
        VALUES(6,1,1,1,1,3, '/uploads/testid/picture5.jpg',"comant5");
INSERT IGNORE INTO items (item_id,category_id,sub_category_id,season_id,color_id,id,picture,comment)
        VALUES(7,1,1,1,1,3, '/uploads/testid/picture6.jpg',"hoge6");
--カレンダー
...
INSERT IGNORE INTO coordinate (coordinate_id,id,coordinate_title,comment,created_at,updated_at,have_calendar)
        VALUES(3, 3,'タイトル', "コメント", "2019-06-17", "2019-06-17",0);
-- 各タグ
...
VALUES(2,2),(3,2),(4,3),(5,3),(6,3),(7,3);
-- 以下Areaデータインサート文
